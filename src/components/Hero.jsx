        ...
        <div className='relative h-dvh w-screen overflow-x-hidden'>
            ...
            {isLoading && (
                <div className='flex-center absolute z-[100] h-dvh w-screen overflow-hidden bg-violet-50'>
                    ...
                    <div id='video-frame' className='relative h-dvh overflow-hidden w-screen z-10 rounded-lg bg-blue-75'>
                <div>
                    <div
                        className='mask-clip-path absolute-center absolute z-50 size-64 overflow-hidden rounded-lg cursor-pointer'>
                    ...
                    <video
                        ...
                        onLoadedData={handleVideoLoad} s
                    />
                </div>
